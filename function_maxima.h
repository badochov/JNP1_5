...
// Even though this class doesn't have custom copy constructor
// and set's default one doesn't have strong exception guarantee
// our class has strong exception guarantee 
// as real copying takes places in cowMutator function,
